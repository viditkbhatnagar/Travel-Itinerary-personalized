...
async function main() {
  ...
  const rishikesh = await prisma.city.upsert({
    ...
    create: {
      ...
      heroImageUrl: 'https://images.unsplash.com/photo-1614605670899-47ecba60bf2a?w=1600',
      latitude: 30.0869,
      longitude: 78.2676,
      isCapital: false,
      avgDailyBudgetINR: 1500,
  ...
  const shimla = await prisma.city.upsert({
    ...
    create: {
      ...
      heroImageUrl: 'https://images.unsplash.com/photo-1597074866923-dc0589150358?w=1600',
      latitude: 31.1048,
      longitude: 77.1734,
      isCapital: false,
      avgDailyBudgetINR: 2500,
  ...
  const lehLadakh = await prisma.city.upsert({
    ...
    create: {
      ...
      heroImageUrl: 'https://images.unsplash.com/photo-1660303954454-cc270a0d48c4?w=1600',
      latitude: 34.1526,
      longitude: 77.5771,
      isCapital: false,
